...
int main( int argc, char** argv)
{
    ...
    #define SLEEP_STATE_ENABLED 0//cannot switch to root and switch CPU into sleep state within the program.
    ...
    if(SLEEP_STATE_ENABLED){
    //struct cpuidle_device *dev = __this_cpu_read(cpuidel_devices);
    //system("sudo su -");system("cd /root");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU1/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU2/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU3/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU4/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU5/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU6/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU7/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU8/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU9/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU10/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU11/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU12/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU13/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU14/throttling");
    system("sudo su -;echo -n 1 > /proc/acpi/processor/CPU15/throttling");
    }
    ...
    n2     = M * N;
    min_mn = min(M, N);
    nb     = magma_get_dgetrf_nb(min_mn);//printf("Wenyi%dZhu%d",M,N);
	...
	SetGPUFreq(2600, 758);//For disabling output of GPU DVFS via nvidia-smi, call NVIDIA NVML library functions directly.//system("sudo nvidia-smi -ac 2600,758 > gpu_dvfs.log");
